...
public class CondivisioneTest {
    ...
    @Test
    void aggiungiCondivisione_throwsException_whenUserNotAuthenticated() {
        assertThrows(NotingException.class, () -> service.aggiungiCondivisione(1, "bob"));
    }

    @Test
    void aggiungiCondivisione_throwsException_whenTargetUsernameIsNullOrEmpty() {
    ...
    @Test
    void aggiungiCondivisione_throwsException_whenNoteDoesNotExist() {
        NoteServiceImpl._setTestUser(new User("alice"));
    ...
    @Test
    void aggiungiCondivisione_throwsException_whenCallerIsNotOwner() {
    ...
    @Test
    void aggiungiCondivisione_throwsException_whenTargetUserDoesNotExist() {
        NoteServiceImpl._setTestUser(new User("alice"));
    ...
    @Test
    void aggiungiCondivisione_throwsException_whenSharingWithSelf() {
        NoteServiceImpl._setTestUser(new User("alice"));
    ...
    void aggiungiCondivisione_addsUserToShareList_whenValidInputs() throws Exception {
         // utente autenticato
        NoteServiceImpl._setTestUser(new User("alice"));
    ...
    @Test
    void aggiungiCondivisione_doesNothing_whenUserAlreadyInShareList() throws Exception {
        NoteServiceImpl._setTestUser(new User("alice"));
